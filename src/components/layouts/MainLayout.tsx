...
import MyCustomIcon from "../../pages/SignUp/components/svg/MyCustomIcon"
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <div className="bg-black text-white py-2 text-center text-sm">
        ...
        <span className="font-medium hover:underline cursor-pointer">Order Now</span>
      </div>
      ...
      <footer className="bg-white pt-16 pb-12 border-t">
        {/* giữ nguyên phần footer như bạn có */}
        {/* ... */}
